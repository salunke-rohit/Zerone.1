        ...
        <div className='container p-2 '>
            <div className='row p-5 '>
                <div className='col-6 p-5'>
                    <h1 className='fs-2 mb-4'>Trust with confidance</h1>
                    <h2 className='fs-4 mb-2'>Custmer-first always</h2>
                    <p className='text-muted'>That's why 1.3+ crore customers trust Zerone with 3.5+ 
                    ...
                    <p className='text-muted'>No gimmicks, spam, "gamification", or annoying push
                         notifications. High quality apps that you use at your pace, the
                          way you like.</p>
                    <h2 className='fs-4 mb-2'>The Zerone universe</h2>
